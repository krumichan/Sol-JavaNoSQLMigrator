...
DROP DATABASE IF EXISTS get_back;
CREATE DATABASE IF NOT EXISTS get_back;
USE get_back;
...
/* interlock_seq */
INSERT INTO interlock_seq (exec_date_time, exec_dml, exec_table, key1, key2, key3, key4) VALUES ('2020-01-17 14:50:52.834892', 'INSERT', 'trn_visual_inspection', '70100999', 'IT00000051', '2020-01-17 05:50:52.834', 'CHK_OK');
...
/* interlock_visual_inspection */
INSERT INTO interlock_visual_inspection (exec_date_time, exec_data_flag, place_id, serial_number, entry_date_time, entry_worker, judgment_key, ng_work_status_key, status_reason_key, status_reason, note, created_by, created_at, updated_by, updated_at) VALUES ('2020-01-17 14:50:52.834892', 1, '70100999', 'IT00000051', '2020-01-17 05:50:52.834', 'testadmin', 'CHK_OK', '', '', '', '外観検査OKテスト', 'testadmin', '2020-01-17 05:50:52', 'testadmin', '2020-01-17 05:50:52');
